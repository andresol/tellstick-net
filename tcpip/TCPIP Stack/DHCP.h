...
typedef enum
{
	...
	SM_DHCP_SEND_REQUEST,		// DHCP is sending a DHCP Send Reequest message (first try)
	SM_DHCP_GET_REQUEST_ACK,	// DCHP is waiting for a Request ACK message
	SM_DHCP_SEND_REQUEST2,		// DHCP is sending a DHCP Send Reequest message (second try)
	SM_DHCP_GET_REQUEST_ACK2,	// DCHP is waiting for a Request ACK message
	SM_DHCP_SEND_REQUEST3,		// DHCP is sending a DHCP Send Reequest message (third try)
	SM_DHCP_GET_REQUEST_ACK3,	// DCHP is waiting for a Request ACK message
	SM_DHCP_SEND_REQUEST4,		// DHCP is sending a DHCP Send Reequest message (fourth try)
	SM_DHCP_GET_REQUEST_ACK4,	// DCHP is waiting for a Request ACK message
